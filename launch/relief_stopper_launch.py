...
def generate_launch_description():
    ...
    config = os.path.join(get_package_share_directory("relief_stopper"), "config", "relief_stopper.param.yaml")
    return LaunchDescription([
        Node(package = "relief_stopper", executable = "relief_stop", output = "screen", parameters = [config])
        ])
